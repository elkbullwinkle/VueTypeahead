...
var MyComponent = __webpack_require__(10);
...
var Bloodhound = __webpack_require__(9);
  ...
  methods: {
    ...
    bloodhoundOption: function () {
      ...
      if (this.prefetch) {
        ...
        if (this.defaultSuggestion) {
          prefetch = _extends({}, prefetch, { transform: this.transformer });
        }
        bloodhoundConfig = { prefetch };
      }
      if (this.local) {
        bloodhoundConfig = _extends({
          local: this.local
        }, bloodhoundConfig);
      }
      if (this.remote) {
    ...
    getSource: function () {
      ...
      var datumTokenizer = this.displayKey ? Bloodhound.tokenizers.obj.whitespace(this.displayKey) : Bloodhound.tokenizers.whitespace;

      var engine = new Bloodhound(_extends({
        datumTokenizer,
    ...
    initTypeahead: function () {
      ...
      $(document).find('#' + self.id).typeahead({
        minLength: 0,
        highlight: true
      }, dataset).on('typeahead:select', function (event, suggession) {
...
Component.options.__file = "/Users/elkbullwinkle/WorkShop/GitHub/vue-typeahead/resources/assets/js/components/VueTypeahead.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-65d7726e", Component.options)
  } else {
    hotAPI.reload("data-v-65d7726e", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('input', {
    ref: "input",
    staticClass: "typeahead-suggestions",
    class: _vm.classes,
    attrs: {
      "id": _vm.id,
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-65d7726e", module.exports)
  }
}
